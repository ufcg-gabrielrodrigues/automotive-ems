...
t_f = 4e-0;	% Tempo total de simula̤̣o [s]

%% Motor a combusṭo interna

% Raẓo entre a polia do motor a combusṭo e a polia do alternador
...
%% Configura̤̣o dos esquemas de controle como entrada do modelo no Simulink
